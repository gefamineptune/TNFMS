try {
    ...
    for (const menu of menus) {
        ...
        role_access_menu_data.forEach(permission => {
            ...
            if (permName === 'View') menuPermissions.View = permission.is_allowed ? true : false;
            if (permName === 'Create') menuPermissions.Create = permission.is_allowed ? true : false;
            if (permName === 'Edit') menuPermissions.Edit = permission.is_allowed ? true : false;
            if (permName === 'Delete') menuPermissions.Delete = permission.is_allowed ? true : false;
        });
